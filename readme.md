...
| Location | Search a place and pick it from the list, then save. The name comes from the search and cannot be edited, so it always matches the coordinates behind it. A preview shows the resulting sun times. |
